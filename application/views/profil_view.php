...
<tr><th scope="row">Nom d'utilisateur : </th><td><?php echo $username ?></td></tr>
<tr><th scope="row">Email : </th><td><?php echo $email ?></td><td><button id="email" type="button" class="btn btn-outline-dark" disabled>Modifier</button></td></tr>
</table>
<?php
...
echo "<p>Compte créé le " . $d->format("d-m-Y") . " .</p>"?>
  ...
  <tr><th scope="row">Nom : </th><td><?php echo $nom ?></td><td><button id="nom" type="button" class="btn btn-outline-dark" >Modifier</button></td></tr>
  <tr><th scope="row">Prénom : </th><td><?php echo $prenom ?></td><td><button id="prenom" type="button" class="btn btn-outline-dark" >Modifier</button></td></tr>
  <tr><th scope="row">Adresse : </th><td><?php echo $code_postal . " " . $ville . " " . $ligne_adresse ?></td><td><button id="adresse" type="button" class="btn btn-outline-dark" disabled>Modifier</button></td></tr>
  </table>
