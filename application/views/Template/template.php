...
<footer class="page-footer font-small blue pt-4 footer">
    ...
    <!-- Footer Links -->
    <div class="container-fluid text-center text-md-left prem_footer">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mt-md-0 mt-3">
                ...
                <!-- Content -->
                <h5 class="text-uppercase">Le monde des chaussures </h5>
                <p>NextDrop est un site ...... MAKE CHOES GREAT AGAIN ! </p>
            ...
            <div class="col-md-3 mb-md-0 mb-3">
                ...
                <div id="social">
                    ...
                    </a> <a href="https://twitter.com" style="text-decoration:none;">
                    ...
                    </a> <a href="https://facebook.com" style="text-decoration:none;">
            ...
            <div class="col-md-3 mb-md-0 mb-3">
                ...
                <!-- Links -->
                <h5 class="text-uppercase">NextDrop</h5>
    ...
    <!-- Copyright -->
    <div class="footer-copyright text-center py-3 sec_footer">© 2018 Copyright: NextDrop 2018 <br/> <a href="https://mdbootstrap.com/education/bootstrap/"> NextDrop.fr</a>
    </div>
    <!-- Copyright -->
